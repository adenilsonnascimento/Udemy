...
try {
	...
	$mail->addAddress('liinknovo2@gmail.ccom', 'Email 2(destinatario)');     //Adiciona um destinatário
	...
	$mail->Subject = 'Curso de PHP';
	$mail->Body    = 'Oi Adenilson, eu sou você e estou te enviando esse Email, do Curso de <strong> PHP </strong>';
	$mail->AltBody = 'Oi Adenilson, eu sou você e estou te enviando esse Email, do Curso de PHP';
